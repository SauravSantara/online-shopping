 ...
 * 
 * import com.niit.shoppingbackend.dao.UserDAO; import
 * com.niit.shoppingbackend.dto.Address; import
 * com.niit.shoppingbackend.dto.Cart; import com.niit.shoppingbackend.dto.User;
 * 
 * public class UserTestCase {
 * 
 * private static AnnotationConfigApplicationContext context; private static
 * UserDAO userDAO; private User user = null; private Cart cart = null; private
 * Address address = null;
 * 
 * @BeforeClass public static void init() { context = new
 * AnnotationConfigApplicationContext();
 * context.scan("com.niit.shoppingbackend"); context.refresh();
 * 
 ...
 * 
 * // add the cart cart.setUser(user);
 * 
 ...
 * cart.setUser(user);
 * 
 * // attach cart with the user user.setCart(cart); } // add the user
 * assertEquals("Failed to add user!", true, userDAO.addUser(user)); }
 * 
 * @Test public void testUpdateCart() {
 * 
 * // fetch the user by its email user = userDAO.getByEmail("mm@gmail.com");
 * 
 ...
 * @Test public void testAddAddress() {
 * 
 * user = userDAO.getByEmail("mm@gmail.com");
 * 
 * // we are also going to add the shipping address address = new Address();
 ...
 * "Mumbai",userDAO.getBillingAddress(user.getId()).getCity()); }
 * 
 * }
 */