 ...
 * 
 * import com.niit.shoppingbackend.dao.CategoryDAO; import
 * com.niit.shoppingbackend.dto.Category;
 * 
 ...
 * category.setImageURL("pre-loader.gif");
 * 
 ...
 * categoryDAO.add(category));
 * 
 * // fetch and update operations category = categoryDAO.get(2);
 * category.setName("TV");
 * assertEquals("Successfully updated a single category in the table!", true,
 * categoryDAO.update(category));
 * 
 ...
 * 
 * // fetching the list
 * assertEquals("Successfully fetched a single category in the table!", 1,
 * categoryDAO.list().size()); }
 * 
 * }
 */