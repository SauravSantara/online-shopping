		...
		<div class="offset-lg-2 col-lg-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<!-- Form Elements -->
					<sf:form class="form-group" modelAttribute="product" action="${contextRoot}/manage/products" method="POST" enctype="multipart/form-data">
      				
						<div class="form-group row">
							<label class="col-form-label col-lg-4" for="name">Enter Product Name: </label>
							<div class="col-lg-8">
						...
						<div class="form-group row">
							<label class="col-form-label col-lg-4" for="brand">Enter Brand Name: </label>
							<div class="col-lg-8">
						...
						<div class="form-group row">
					       <label class="col-form-label col-lg-4" for="description">Product Description: </label>
					       <div class="col-lg-8">
					    ...
					    <div class="form-group row">
					       <label class="col-form-label col-lg-4" for="unitPrice">Enter Unit Price: </label>
					       <div class="col-lg-8">
					    ...
					    <div class="form-group row">
					       <label class="col-form-label col-lg-4" for="quantity">Quantity Available: </label>
					       <div class="col-lg-8">
					    ...
					    <div class="form-group row">
					       <label class="col-form-label col-lg-4" for="file">Select an Image: </label>
					       <div class="col-lg-8">
					    ...
					    <div class="form-group row">
					       <label class="col-form-label col-lg-4" for="categoryId">Select Category: </label>
					       <div class="col-lg-8">
	 	...
	 	<div class="modal-dialog" role="document">
	 		<div class="modal-content">
	 			...
	 			<div class="modal-body">
	 				...
	 				<!-- Category Form -->
	 				<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category" method="POST" class="form-group">
